...
class salaryController extends Controller
{
    ...
    public function create_teacher_salary(Request $request, $id)
    {
        ...
        return view('accounting.expenses_form')->with('info' , $info)->with('salary', 'salary')->with('teacher_salary', 'teacher_salary');
    }
    ...
    public function create_employee_salary(Request $request, $id)
    {
        ...
        return view('accounting.expenses_form')->with('info' , $info)->with('salary', 'salary')->with('employee_salary', 'employee_salary');
    }
